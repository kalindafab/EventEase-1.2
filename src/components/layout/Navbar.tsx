...
import { useTranslation } from './transaction'; // Import the translation hook
      ...
      <div className="container-custom">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link
              to="/"
              className={`font-medium hover:text-primary-600 dark:hover:text-primary-400 transition-colors ${isCurrentPath('/')
            ...
            <Link
              to="/dashboard"
              className={`font-medium hover:text-primary-600 dark:hover:text-primary-400 transition-colors ${isCurrentPath('/dashboard')
                ? 'text-primary-600 dark:text-primary-400'
                : 'text-gray-700 dark:text-gray-300'
                }`}
            >
            ...
            <div className="flex gap-2 items-center text-sm">
              ...
              <button
                ...
                className={language === 'fr' ? 'font-bold underline' : ''}
              >
                FR
              </button>
            </div>
      ...
      {isMenuOpen && (
        ...
        >
          <div className="container-custom py-4 space-y-4">
            <Link
              to="/"
              className={`block py-2 font-medium ${isCurrentPath('/')
                ? 'text-primary-600 dark:text-primary-400'
                : 'text-gray-700 dark:text-gray-300'
                }`}
            ...
            <Link
              to="/dashboard"
              className={`block py-2 font-medium ${isCurrentPath('/dashboard')
                ? 'text-primary-600 dark:text-primary-400'
                : 'text-gray-700 dark:text-gray-300'
                }`}
              onClick={() => setIsMenuOpen(false)}
