  ...
  return (
    ...
    >
      <Link to={`/event/${event.id}`} className="block h-full">
        <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-card dark:shadow-gray-700/20 h-full flex flex-col transition-all duration-300">
          ...
          <div className="p-5 flex-grow flex flex-col">
            <div className="flex-grow">
              <h3 className="text-xl font-semibold mb-2 line-clamp-2 text-gray-900 dark:text-white">{event.title}</h3>
