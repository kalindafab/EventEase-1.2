          ...
          >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
              ...
              <div className="flex items-center">
                <div className="w-16 h-16 rounded-full bg-primary-100 dark:bg-gray-700 flex items-center justify-center mr-4">
                  <Users className="h-8 w-8 text-primary-600 dark:text-primary-400" />
                </div>
                <div>
                  <h3 className="text-lg font-semibold dark:text-white">{event.organizerName}</h3>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 sticky top-24">
              ...
              <div className="pt-6 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="flex space-x-2">
                  <button className="p-2 bg-blue-100 text-blue-600 rounded-full hover:bg-blue-200 transition-colors dark:bg-blue-900/30 dark:text-blue-400 dark:hover:bg-blue-900/50">
                  ...
                  <button className="p-2 bg-green-100 text-green-600 rounded-full hover:bg-green-200 transition-colors dark:bg-green-900/30 dark:text-green-400 dark:hover:bg-green-900/50">
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
