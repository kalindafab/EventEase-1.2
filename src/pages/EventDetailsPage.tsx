...
const EventDetailsPage = () => {
  ...
  if (loading) {
    return (
      <div className="container-custom py-16 text-center dark:bg-gray-900 dark:text-gray-100">
    ...
    <div className="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors">
      ...
      <div className="relative bg-primary-900 dark:bg-gray-800 h-64 md:h-80 lg:h-96 overflow-hidden">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-primary-900/80 to-primary-900/50 dark:from-gray-900/90 dark:to-gray-800/60"></div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              <motion.button
                className={`flex items-center px-4 py-2 rounded-lg ${
                  isLiked ? 'bg-red-100 text-red-600 dark:bg-red-900/30 dark:text-red-400' : 'bg-gray-100 text-gray-700 hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700'
                } transition-colors`}
                onClick={toggleLike}
              ...
              <motion.button
                className="flex items-center px-4 py-2 rounded-lg bg-gray-100 text-gray-700 hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700 transition-colors"
                onClick={shareEvent}
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 mb-8">
              <h2 className="text-2xl font-bold mb-4 dark:text-white">About This Event</h2>
              <p className="text-gray-700 dark:text-gray-300 whitespace-pre-line">{event.description}</p>
            </div>
            
            {/* Organizer Info */}
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
              <h2 className="text-2xl font-bold mb-4 dark:text-white">Organizer</h2>
              <div className="flex items-center">
                ...
                />
                <div>
                  <h3 className="text-lg font-semibold dark:text-white">{event.organizer.name}</h3>
          ...
          >
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 sticky top-24">
              <div className="mb-6">
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-medium dark:text-white">Date and Time</p>
              ...
              <div className="pt-6 border-t border-gray-200 dark:border-gray-700">
                <h4 className="font-medium mb-2 dark:text-white">Share with friends</h4>
                <div className="flex space-x-2">
                  <button className="p-2 bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400 rounded-full hover:bg-blue-200 dark:hover:bg-blue-900/50 transition-colors">
                  ...
                  <button className="p-2 bg-green-100 text-green-600 dark:bg-green-900/30 dark:text-green-400 rounded-full hover:bg-green-200 dark:hover:bg-green-900/50 transition-colors">
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                    </svg>
                  </button>
                  <button className="p-2 bg-red-100 text-red-600 dark:bg-red-900/30 dark:text-red-400 rounded-full hover:bg-red-200 dark:hover:bg-red-900/50 transition-colors">
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
