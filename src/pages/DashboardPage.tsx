        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-6 bg-gray-50 dark:bg-gray-900">
          {isNestedRoute ? (
            ...
            <>
              <div className="mb-6">
                <motion.h1 
                  className="text-2xl font-bold mb-1 dark:text-white"
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                ...
                >
                  <div className="flex justify-between items-center mb-6">
                    <h2 className="text-lg font-semibold dark:text-white">Activity Overview</h2>
                  ...
                  <div className="flex gap-6 mb-4">
                    <div className="flex-1">
                      ...
                      <p className="text-2xl font-bold dark:text-white">482</p>
                    </div>
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-2xl font-bold dark:text-white">1,749</p>
                    </div>
                  </div>
                  
                  {/* Simple Chart Mockup */}
                  <div className="h-60 mt-8">
                    <div className="w-full h-full bg-gradient-to-t from-primary-100 dark:from-primary-900/20 to-transparent relative rounded-lg overflow-hidden">
                      {[...Array(7)].map((_, i) => (
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start pb-4 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <div>
                      <p className="text-sm font-medium dark:text-white">New Registration</p>
                      <p className="text-sm text-gray-600 dark:text-gray-300">John Doe registered for "TechConnect Conference 2025"</p>
                  ...
                  <div className="flex items-start pb-4 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-300">You received $299 for "Summer Music Festival" ticket</p>
                  ...
                  <div className="flex items-start pb-4 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <div>
                      <p className="text-sm font-medium dark:text-white">Event Update</p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="text-sm font-medium dark:text-white">Milestone Reached</p>
